...
public class JavascriptPolicyV4IntegrationTest {
    ...
    @GatewayTest
    @Nested
    class HttpProxyTest extends AbstractPolicyTest<JavascriptPolicy, JavascriptPolicyConfiguration> {
    ...
    @GatewayTest
    @Nested
    class SubscribeTest extends AbstractPolicyTest<JavascriptPolicy, JavascriptPolicyConfiguration> {
    ...
    @GatewayTest
    @Nested
    class PublishTest extends AbstractPolicyTest<JavascriptPolicy, JavascriptPolicyConfiguration> {
