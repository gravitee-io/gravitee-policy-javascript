 ...
 */
package io.gravitee.policy.javascript.model.js.message;
...
public class JsMessageAttributes implements Map<String, Object> {

    private final Message message;
    private final Map<String, Object> attributes;

    public JsMessageAttributes(Message message) {
    ...
    @Override
    public void putAll(Map<? extends String, ?> all) {
