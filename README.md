...
[![Gravitee.io](https://img.shields.io/static/v1?label=Available%20at&message=Gravitee.io&color=1EC9D2)](https://download.gravitee.io/#graviteeio-apim/plugins/policies/gravitee-policy-javascript/)
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://github.com/gravitee-io/gravitee-policy-javascript/blob/master/LICENSE.txt)
[![Releases](https://img.shields.io/badge/semantic--release-conventional%20commits-e10079?logo=semantic-release)](https://github.com/gravitee-io/gravitee-policy-javascript/releases)
...
```
*Proxy API on Request phase - override content*
```json
{
  "api": {
    "definitionVersion": "V4",
...
### [3.0.0-alpha.1](https://github.com/gravitee-io/gravitee-policy-javascript/compare/2.1.0...3.0.0-alpha.1) (2026-04-22)


##### Bug Fixes

* add cause to execution failure ([7f5c977](https://github.com/gravitee-io/gravitee-policy-javascript/commit/7f5c977cb7ede9d8ce3f07a91eb6f23f016d978a))


##### Features

* upgrade to vertx 5 ([6c63be2](https://github.com/gravitee-io/gravitee-policy-javascript/commit/6c63be27e23ef88240734a1a2f03c1ee25b73e58))
